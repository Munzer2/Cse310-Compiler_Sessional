...
{
       0,    55,    55,    70,    83,    91,   101,   112,   120,   152,
     178,   183,   216,   254,   261,   279,   289,   306,   316,   315,
     334,   343,   355,   360,   370,   380,   391,   419,   450,   475,
     505,   515,   524,   531,   538,   545,   558,   569,   582,   593,
     604,   613,   618,   624,   631,   642,   649,   669,   725,   735,
     798,   808,   898,   908,   976,   985,  1111,  1121,  1466,  1483,
    1505,  1516,  1524,  1558,  1568,  1579,  1590,  1617,  1645,  1653,
    1657,  1666
};
#endif
...
#line 986 "2005018.y"
                {
                    ...
                    (yyval.symbVal)->node = new treeNode(line_count,(yyvsp[-2].symbVal)->node->getfirstLine(),"simple_expression ADDOP term","NULL");
                    (yyval.symbVal)->node->addChild((yyvsp[-2].symbVal)->node);
                    (yyval.symbVal)->node->addChild((yyvsp[-1].symbVal)->node);
                    (yyval.symbVal)->node->addChild((yyvsp[0].symbVal)->node);
                }
